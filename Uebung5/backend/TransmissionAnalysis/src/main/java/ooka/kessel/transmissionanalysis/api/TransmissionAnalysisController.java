...
import ooka.kessel.transmissionanalysis.dto.AnalysisResult;
import ooka.kessel.transmissionanalysis.dto.ConfigurationRequest;
import ooka.kessel.transmissionanalysis.kafka.AnalysisResultProducer;
...
public class TransmissionAnalysisController {
    ...
    private final static Logger logger = LoggerFactory.getLogger(TransmissionAnalysisController.class);

    @Autowired
    public TransmissionAnalysisController(AnalysisResultProducer resultProducer) {
        this.resultProducer = resultProducer;
    }

    @KafkaListener(topics = "transmission-analysis", groupId = "starting-system-1", containerFactory = "kafkaListenerContainerFactory")
